...
#define PREHEAT_HOTEND   {205,   245,    235,   240}
#define PREHEAT_BED      {60,    80,     100,   80}
...
#define NOZZLE_PAUSE_X_POSITION     120  // (mm) Must be an integer
#define NOZZLE_PAUSE_Y_POSITION     120  // (mm) Must be an integer
