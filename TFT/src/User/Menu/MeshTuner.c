...
//  probeHeightEnable();                                     // temporary disable software endstops
  ...
  mustStoreCmd("G42 I%d J%d F%d\n",
    col,
    row,
    infoSettings.level_feedrate[FEEDRATE_XY]);                 // move nozzle to X and Y coordinates corresponding
...
//  if (infoMachineSettings.zProbe == ENABLED)    //SUTAS
//    probeHeightStop();                          //SUTAS           // raise nozzle
