...
#define _LANGUAGE_PL_H_
    ...
    #define PL_ABL                    "ABL"
    #define PL_ABL_COMPLETE           "Bed Leveling Complete"
    #define PL_ABL_SMART_FILL         "Missing probe points\nhave been smart filled.\n \nNote: remember to save!"
    #define PL_ABL_SETTINGS           "Bilinear Bed Leveling"
    ...
    #define PL_ABL_ENABLE             "ABL: on"
    #define PL_ABL_DISABLE            "ABL: off"
    ...
    #define PL_INVALID_VALUE          "No valid value/s provided!"
    #define PL_TIMEOUT_REACHED        "Timeout reached!"
    #define PL_PROCESS_RUNNING        "Process running! Wait completion"
    ...
    #define PL_ACK_POPUP_TYPE         "ACK popup type"
    #define PL_ACK_BUZZER             "ACK buzzer"
    ...
    #define PL_PID_START_INFO         "PID autotune will be started. It can take minutes. Continue?"
	...
	#define PL_NOTIFY_KILL			  "Printer Killed!"
	#define PL_NOTIFY_CANCEL		  "Print Job Cancelled!"
	#define PL_NOTIFY_RESUME		  "Print Job Resumed!"
	#define PL_NOTIFY_PAUSE			  "Print Job Paused!"
#endif
