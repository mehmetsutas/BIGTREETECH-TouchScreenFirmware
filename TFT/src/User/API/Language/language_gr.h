...
#define _LANGUAGE_GR_H_
    ...
    #define STRING_INVERT_X_AXIS          "Αντιστρέψει X άξονα"
    #define STRING_INVERT_Y_AXIS          "Αντιστρέψει Y άξονα"
    #define STRING_INVERT_Z_AXIS          "Αντιστρέψει Z άξονα"
    ...
    #define STRING_PS_ON                  "Αυτόματη απενεργοποίηση"
    ...
    #define STRING_SETTINGS_RESET_INFO    "Όλες οι ρυθμίσεις θα \nεπαναφερθούν στις προεπιλεγμένες \nτιμές. Συνεχίσει?"
    #define STRING_SETTINGS_RESET_DONE    "Η επαναφορά όλων των ρυθμίσεων \nολοκληρώθηκε με επιτυχία. \nΓια πλήρη εφαρμογή,\nπαρακάλω επανεκκινήστε τη συσκευή σας."
