...
#define _LANGUAGE_CN_H_
    ...
    #define STRING_INVERT_X_AXIS          "翻转X轴"
    #define STRING_INVERT_Y_AXIS          "翻转Y轴"
    #define STRING_INVERT_Z_AXIS          "翻转Z轴"
    #define STRING_PERSISTENT_INFO        "顶部温度信息"
    #define STRING_FILE_LIST_MODE         "文件浏览列表模式"
    #define STRING_ACK_NOTIFICATION       "ACK 弹窗类型"
    #define STRING_DEFAULT_MODE           "默认的模式"
    ...
    #define STRING_ONBOARD_SD_SUPPORT     "Marlin存储卡支持"
    #define STRING_M27_ALWAYS_ACTIVE      "持续发送M27"
    #define STRING_LONG_FILENAME_SUPPORT  "Marlin长文件名支持"
    ...
    #define STRING_PS_ON_ACTIVE_HIGH      "低电平关机"
    #define STRING_FIL_RUNOUT             "耗材检测传感器"
    #define STRING_FIL_RUNOUT_INVERTING   "翻转耗材检测逻辑"
