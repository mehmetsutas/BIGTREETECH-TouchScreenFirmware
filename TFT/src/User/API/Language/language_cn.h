...
#define _LANGUAGE_CN_H_
    ...
    #define CN_ABL                    "自动调平"
    #define CN_ABL_COMPLETE           "平台调平完成!"
    #define CN_ABL_SMART_FILL         "部分点未探测,已被自动填充, 需要手动保存!"
    #define CN_ABL_SETTINGS           "Bilinear Bed Leveling"
    #define CN_ABL_SETTINGS_UBL       "Unified Bed Leveling"
    #define CN_ABL_SETTINGS_UBL_SAVE  "Save to slot"
    #define CN_ABL_SETTINGS_UBL_LOAD  "Load from slot"
    #define CN_ABL_SLOT0              "Slot 0"
    #define CN_ABL_SLOT1              "Slot 1"
    #define CN_ABL_SLOT2              "Slot 2"
    #define CN_ABL_SLOT3              "Slot 3"
    #define CN_ABL_SLOT_EEPROM        "Remember slot for next\nreboot? (Save EEPROM)"
    #define CN_ABL_Z                  "Z Fade"
    #define CN_ABL_ENABLE             "ABL:已开启"
    #define CN_ABL_DISABLE            "ABL:已关闭"
    ...
    #define CN_CONFIRMATION           "Are you sure?"
    #define CN_DOWN                   "降低"
    #define CN_UP                     "抬升"
    #define CN_SAVE                   "保存参数"
    ...
    #define CN_TIMEOUT_REACHED        "已超时!"
    #define CN_PROCESS_RUNNING        "正在运行,请稍后"
    #define CN_PROCESS_COMPLETED      "处理已完成!"
    #define CN_PROCESS_ABORTED        "处理已被中断!"
    #define CN_APPLY                  "应用"
    #define CN_INC                    "增加"
    #define CN_DEC                    "减少"
    #define CN_NOZZLE                 "喷头"
    ...
    #define CN_KNOB_LED_IDLE          "旋钮LED自动睡眠"
    ...
    #define CN_LIN_ADVANCE            "Linear Advance"
    ...
    #define CN_TUNING                 "调整"
    #define CN_PID                    "PID"
    #define CN_PID_TITLE              "PID自动整定"
    #define CN_PID_START_INFO         "开始PID自动整定,需要几分钟来完成,是否继续?"
