...
#define _LANGUAGE_IT_H_
    ...
    #define STRING_INVERT_X_AXIS          "Inverti asse X"
    #define STRING_INVERT_Y_AXIS          "Inverti asse Y"
    #define STRING_INVERT_Z_AXIS          "Inverti asse Z"
    ...
    #define STRING_DEFAULT_MODE           "Modalità default"
    ...
    #define STRING_ONBOARD_SD_SUPPORT     "Supporto SD onboard"
    #define STRING_M27_ALWAYS_ACTIVE      "M27 sempre attivo"
    #define STRING_LONG_FILENAME_SUPPORT  "Supporto nomi lunghi"
    ...
    #define STRING_PS_ON_ACTIVE_HIGH      "Alimentatore attivo HIGH"
    #define STRING_FIL_RUNOUT             "Sensore filamento"
    #define STRING_FIL_RUNOUT_INVERTING   "Inv. logica sens. filamento"
    ...
    #define STRING_SETTINGS_RESET_INFO    "Resettare tutte le impostazioni\nai valori di default?"
    #define STRING_SETTINGS_RESET_DONE    "Reset delle impostazioni\navvenuto con successo.\nRiavviare la stampante prego."
