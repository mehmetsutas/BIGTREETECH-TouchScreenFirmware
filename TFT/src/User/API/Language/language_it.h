...
#define _LANGUAGE_IT_H_
    ...
    #define IT_ABL                    "ABL"
    #define IT_ABL_COMPLETE           "Bed Leveling Complete"
    #define IT_ABL_SMART_FILL         "Missing probe points\nhave been smart filled.\n \nNote: remember to save!"
    #define IT_ABL_SETTINGS           "Bilinear Bed Leveling"
    #define IT_ABL_SETTINGS_UBL       "Unified Bed Leveling"
    #define IT_ABL_SETTINGS_UBL_SAVE  "Save to slot"
    #define IT_ABL_SETTINGS_UBL_LOAD  "Load from slot"
    #define IT_ABL_SLOT0              "Slot 0"
    #define IT_ABL_SLOT1              "Slot 1"
    #define IT_ABL_SLOT2              "Slot 2"
    #define IT_ABL_SLOT3              "Slot 3"
    #define IT_ABL_SLOT_EEPROM        "Remember slot for next\nreboot? (Save EEPROM)"
    #define IT_ABL_Z                  "Z Fade"
    #define IT_ABL_ENABLE             "ABL: on"
    #define IT_ABL_DISABLE            "ABL: off"
    ...
    #define IT_CONFIRMATION           "Are you sure?"
    #define IT_DOWN                   "Down"
    #define IT_UP                     "Up"
    #define IT_SAVE                   "Salva"
    #define IT_RESTORE                "Restore"
    #define IT_RESET                  "Reset"
    #define IT_DEFAULT                "Default"
    #define IT_NEXT                   "Next"
    #define IT_DISTANCE               "Distance"
    #define IT_INVALID_VALUE          "No valid value/s provided!"
    #define IT_TIMEOUT_REACHED        "Timeout reached!"
    #define IT_PROCESS_RUNNING        "Process running! Wait completion"
    ...
    #define IT_KNOB_LED_IDLE          "Rotary Knob LED idle"
    ...
    #define IT_FWRETRACT              "FW Retraction"
    #define IT_FWRECOVER              "FW Retraction Recover"
    #define IT_LIN_ADVANCE            "Linear Advance"
    ...
    #define IT_RETRACT_AUTO           "Auto Firmware Retract"
    ...
    #define IT_ACK_POPUP_TYPE         "ACK popup type"
    #define IT_ACK_BUZZER             "ACK buzzer"
    #define IT_LEVELING_EDGE_DISTANCE "Bed edge distance"
    #define IT_XY_UNLOCK              "Sblocca XY"
    #define IT_TUNING                 "Tuning"
    #define IT_PID                    "PID"
    #define IT_PID_TITLE              "PID autotune"
    #define IT_PID_START_INFO         "PID autotune will be started. It can take minutes. Continue?"
    #define IT_PID_START_INFO_2       "PID autotune in progress!"
	...
	#define IT_NOTIFY_KILL			  "Printer Killed!"
	#define IT_NOTIFY_CANCEL		  "Print Job Cancelled!"
	#define IT_NOTIFY_RESUME		  "Print Job Resumed!"
	#define IT_NOTIFY_PAUSE			  "Print Job Paused!"
#endif
