...
#define _LANGUAGE_RU_H_
    ...
    #define RU_LEVELING             "Калиб.стола"
    ...
    #define RU_BLTOUCH_REPEAT       "Повторить"
    ...
    #define RU_LEDWHITE             "Белый"
    #define RU_LEDRED               "Красный"
    #define RU_LEDORANGE            "Оранжевый"
    #define RU_LEDYELLOW            "Жёлтый"
    #define RU_LEDGREEN             "Зелёный"
    #define RU_LEDBLUE              "Синий"
    #define RU_LEDINDIGO            "Индиго"
    #define RU_LEDVIOLET            "Фиолетовый"
