...
#define _LANGUAGE_RU_H_
    ...
    #define RU_ABL_ENABLE             "ABL: вкл"
    #define RU_ABL_DISABLE            "ABL: выкл"
    ...
    #define RU_INVALID_VALUE          "Остутствуют правильные\nзначения!"
    ...
    #define RU_SETTING_SAVE           "Save settings"
    ...
    #define RU_RETRACT_AUTO           "Auto Firmware Retract"
    ...
    #define RU_SWAP_RECOVER_LENGTH    "Длина при смене сопла"
    #define RU_START_PRINT            "Начать печать:\n %s?"
    #define RU_ACK_POPUP_TYPE         "ACK всплывающие окна"
    #define RU_ACK_BUZZER             "ACK динамика"
    #define RU_LEVELING_EDGE_DISTANCE "Отступы от краёв стола"
    #define RU_XY_UNLOCK              "XY отпустить"
    #define RU_TUNING                 "Наладка"
    #define RU_PID                    "PID"
    #define RU_PID_TITLE              "PID автонастройка"
    #define RU_PID_START_INFO         "Сейчас будет запущена PID\nавтонастройка, это займёт\nнекоторое время. Продолжить?"
