...
#define _LANGUAGE_SK_H_
    ...
    #define SK_DOWN                   "Down"
    #define SK_UP                     "Up"
    #define SK_SAVE                   "Uložiť"
    #define SK_RESTORE                "Restore"
    #define SK_RESET                  "Reset"
    #define SK_DEFAULT                "Default"
    #define SK_NEXT                   "Next"
    #define SK_DISTANCE               "Distance"
    #define SK_INVALID_VALUE          "No valid value/s provided!"
    #define SK_TIMEOUT_REACHED        "Timeout reached!"
    #define SK_PROCESS_RUNNING        "Process running! Wait completion"
    ...
    #define SK_RETRACT_AUTO           "Auto Firmware Retract"
    ...
    #define SK_ACK_POPUP_TYPE         "ACK popup type"
    #define SK_ACK_BUZZER             "ACK buzzer"
    #define SK_LEVELING_EDGE_DISTANCE "Bed edge distance"
    #define SK_XY_UNLOCK              "Odomknite XY"
    #define SK_TUNING                 "Tuning"
    #define SK_PID                    "PID"
    #define SK_PID_TITLE              "PID autotune"
    #define SK_PID_START_INFO         "PID autotune will be started. It can take minutes. Continue?"
    #define SK_PID_START_INFO_2       "PID autotune in progress!"
