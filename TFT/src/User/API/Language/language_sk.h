...
#define _LANGUAGE_SK_H_
    ...
    #define SK_LEDOFF               "OFF" 
    #define SK_LEDWHITE             "White"
    #define SK_LEDRED               "Red"
    #define SK_LEDORANGE            "Orange"
    #define SK_LEDYELLOW            "Yellow"
    #define SK_LEDGREEN             "Green"
    #define SK_LEDBLUE              "Blue"
    #define SK_LEDINDIGO            "Indigo"
    #define SK_LEDVIOLET            "Violet"
    #define SK_ON                   "ON"
    #define SK_OFF                  "OFF"
    #define SK_AUTO                 "AUTO"
