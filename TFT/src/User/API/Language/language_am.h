...
#define _LANGUAGE_AM_H_
    ...
    #define AM_NOTIFY_PAUSE			"Baskı duraklatıldı!"
    #define AM_NOTIFY_RESUME		"Baskı sürdürülüyor!"
    #define AM_NOTIFY_KILL			"Cihaz durduruldu!!!"
    #define AM_NOTIFY_CANCEL		"Baskı iptal edildi!"
	#define AM_PROMPT_FILAMENT_INSERT		"Filaman yükleyiniz!"
	#define AM_PROMPT_HEATER_TIMEOUT		"Güvenlik için nozül soğutuldu. Isıtılsın mı?"
	#define AM_PROMPT_REHEATING		"Isınıyor..."
	#define AM_PROMPT_REHEAT_DONE	"Isınma tamamlandı."
    #define AM_FILAMENT_LOAD        "Yükle"                               //"Load"
    #define AM_FILAMENT_UNLOAD      "Boşalt"  
	#define AM_FILAMENT_CHANGE      "F. Değiş."
	#define AM_PROMPT_FILAMENT_LOAD  "Filamanı ekstrudere yerleştiriniz."      
	#define AM_PROMPT_FILAMENT_CONTINUE  "İşlem tamamlanacak."   
