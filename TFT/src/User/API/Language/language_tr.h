...
#define _LANGUAGE_TR_H_
    ...
    #define STRING_PROBE_OFFSET           "Prob Ofseti"
    #define STRING_HOME_OFFSET            "Sıfırlama Ofseti"
    ...
    #define STRING_KNOB_LED_IDLE          "Döner Düğme LED bekleme"
