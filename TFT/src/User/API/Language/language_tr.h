...
#define _LANGUAGE_TR_H_
    ...
    #define STRING_INVERT_X_AXIS          "X Eksenini Tersine Çevir"
    #define STRING_INVERT_Y_AXIS          "Y Eksenini Tersine Çevir"
    #define STRING_INVERT_Z_AXIS          "Z Eksenini Tersine Çevir"
    ...
    #define STRING_DEFAULT_MODE           "Varsayılan Mod"
    ...
    #define STRING_ONBOARD_SD_SUPPORT     "Dahili SD Desteği"
    #define STRING_M27_ALWAYS_ACTIVE      "M27 Sürekli Aktif"
    #define STRING_LONG_FILENAME_SUPPORT  "Uzun Dosya Adı Desteği"
    ...
    #define STRING_FIL_RUNOUT_INVERTING   "Ters Filaman Algılama Sinyali"
    ...
    #define STRING_SETTINGS_RESET_INFO    "Tüm ayarlar varsayılana\ndeğerlere sıfırlanacak.\nDevam edilsin mi?"
    #define STRING_SETTINGS_RESET_DONE    "Tüm ayarlar başarıyla\nsıfırlandı. Yeni ayarların\netkili olması için\ncihazı yeniden başlatın."
