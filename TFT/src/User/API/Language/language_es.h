...
#define _LANGUAGE_ES_H_
    ...
    #define ES_ABL                    "ABL"
    #define ES_ABL_COMPLETE           "Bed Leveling Complete"
    ...
    #define ES_ABL_SLOT_EEPROM        "Remember slot for next\nreboot? (Save EEPROM)"
    ...
    #define ES_CONFIRMATION           "Are you sure?"
    #define ES_DOWN                   "Down"
    #define ES_UP                     "Up"
    #define ES_SAVE                   "Grabar"
    #define ES_RESTORE                "Restore"
    #define ES_RESET                  "Reset"
    #define ES_DEFAULT                "Default"
    #define ES_NEXT                   "Next"
    #define ES_DISTANCE               "Distance"
    #define ES_INVALID_VALUE          "No valid value/s provided!"
    #define ES_TIMEOUT_REACHED        "Timeout reached!"
    #define ES_PROCESS_RUNNING        "Process running! Wait completion"
    ...
    #define ES_RETRACT_AUTO           "Auto Firmware Retract"
    ...
    #define ES_ACK_POPUP_TYPE         "ACK popup type"
    #define ES_ACK_BUZZER             "ACK buzzer"
    #define ES_LEVELING_EDGE_DISTANCE "Bed edge distance"
    #define ES_XY_UNLOCK              "Desbloquear XY"
    #define ES_TUNING                 "Tuning"
    #define ES_PID                    "PID"
    #define ES_PID_TITLE              "PID autotune"
    #define ES_PID_START_INFO         "PID autotune will be started. It can take minutes. Continue?"
    #define ES_PID_START_INFO_2       "PID autotune in progress!"
