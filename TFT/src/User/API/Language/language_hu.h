...
#define _LANGUAGE_HU_H_
    ...
    #define HU_PROCESS_RUNNING        "Folyamat fut! Várd meg a befejezést!"
    ...
    #define HU_SETTING_SAVE           "Save settings"
    ...
    #define HU_RETRACT_AUTO           "Auto Firmware Retract"
    ...
    #define HU_ACK_POPUP_TYPE         "ACK felugró típus"
    #define HU_ACK_BUZZER             "ACK hangjelző"
