...
#define _LANGUAGE_DU_H_
    ...
    #define STRING_INVERT_X_AXIS          "Inverteer X Axis"
    #define STRING_INVERT_Y_AXIS          "Inverteer Y Axis"
    #define STRING_INVERT_Z_AXIS          "Inverteer Z Axis"
    ...
    #define STRING_LCD_IDLE_BRIGHTNESS    "LCD Brightness dim"
    #define STRING_LCD_IDLE_DELAY         "LCD dim idle timer"
