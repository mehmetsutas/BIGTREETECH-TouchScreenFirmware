...
#define _LANGUAGE_JP_H_
    ...
    #define JP_ABL_SMART_FILL         "Missing probe points\nhave been smart filled.\n \nNote: remember to save!"
    #define JP_ABL_SETTINGS           "Bilinear Bed Leveling"
    #define JP_ABL_SETTINGS_UBL       "Unified Bed Leveling"
    #define JP_ABL_SETTINGS_UBL_SAVE  "Save to slot"
    #define JP_ABL_SETTINGS_UBL_LOAD  "Load from slot"
    #define JP_ABL_SLOT0              "Slot 0"
    ...
    #define JP_CONFIRMATION           "Are you sure?"
    #define JP_DOWN                   "Down"
    #define JP_UP                     "Up"
    #define JP_SAVE                   "保存"
    ...
    #define JP_INVALID_VALUE          "No valid value/s provided!"
    #define JP_TIMEOUT_REACHED        "Timeout reached!"
    #define JP_PROCESS_RUNNING        "Process running! Wait completion"
    ...
    #define JP_RETRACT_AUTO           "Auto Firmware Retract"
    ...
    #define JP_ACK_POPUP_TYPE         "ACK popup type"
    #define JP_ACK_BUZZER             "ACK buzzer"
    ...
    #define JP_PID_START_INFO         "PID autotune will be started. It can take minutes. Continue?"
    #define JP_PID_START_INFO_2       "PID autotune in progress!"
