...
#define _LANGUAGE_EN_H_
    ...
    #define EN_RGB_RED              "Red"
    #define EN_RGB_GREEN            "Green"
    #define EN_RGB_BLUE             "Blue"
    #define EN_RGB_WHITE            "White"
    ...
    #define EN_LEDOFF               "OFF" 
    #define EN_LEDWHITE             "White"
    #define EN_LEDRED               "Red"
    #define EN_LEDORANGE            "Orange"
    #define EN_LEDYELLOW            "Yellow"
    #define EN_LEDGREEN             "Green"
    #define EN_LEDBLUE              "Blue"
    #define EN_LEDINDIGO            "Indigo"
    #define EN_LEDVIOLET            "Violet"
    ...
    #define EN_NOTIFY_PAUSE			"Baskı duraklatıldı!"
    #define EN_NOTIFY_RESUME		"Baskı sürdürülüyor!"
    #define EN_NOTIFY_KILL			"Cihaz durduruldu!!!"
    #define EN_NOTIFY_CANCEL		"Baskı iptal edildi!"
	#define EN_PROMPT_FILAMENT_INSERT		"Filaman yükleyiniz!"
	#define EN_PROMPT_HEATER_TIMEOUT		"Güvenlik için nozül soğutuldu. Isıtılsın mı?"
	#define EN_PROMPT_REHEATING		"Isınıyor..."
	#define EN_PROMPT_REHEAT_DONE	"Isınma tamamlandı."
    #define EN_FILAMENT_LOAD        "Yükle"                               //"Load"
    #define EN_FILAMENT_UNLOAD      "Boşalt"  
	#define EN_FILAMENT_CHANGE      "F. Değiş."
	#define EN_PROMPT_FILAMENT_LOAD  "Filamanı ekstrudere yerleştiriniz."      
	#define EN_PROMPT_FILAMENT_CONTINUE  "İşlem tamamlanacak."   
	#define EN_PROMPT_NOZZLE_PARKED  "Ekstruder park edildi." 
	#define EN_PROMPT_M0_M1          "Programlanmış duraklama! Devam?"
#endif
