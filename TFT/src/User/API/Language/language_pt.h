...
#define _LANGUAGE_PT_H_
    ...
    #define PT_INVALID_VALUE          "No valid value/s provided!"
    #define PT_TIMEOUT_REACHED        "Timeout reached!"
    #define PT_PROCESS_RUNNING        "Process running! Wait completion"
    ...
    #define PT_ACK_POPUP_TYPE         "ACK popup type"
    #define PT_ACK_BUZZER             "ACK buzzer"
    ...
    #define PT_PID_START_INFO         "PID autotune will be started. It can take minutes. Continue?"
