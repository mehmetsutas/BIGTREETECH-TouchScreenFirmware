...
enum
{
  ...
  LABEL_NOTIFY_KILL,
  LABEL_NOTIFY_CANCEL,
  LABEL_PROMPT_FILAMENT_INSERT,
  LABEL_PROMPT_HEATER_TIMEOUT,
  LABEL_PROMPT_REHEATING,
  LABEL_PROMPT_REHEAT_DONE,
  LABEL_FILAMENT_LOAD,
  LABEL_FILAMENT_UNLOAD,
  LABEL_FILAMENT_CHANGE,
  LABEL_PROMPT_FILAMENT_LOAD,
  LABEL_PROMPT_FILAMENT_CONTINUE,
  LABEL_PROMPT_NOZZLE_PARKED,
  LABEL_PROMPT_M0_M1,
