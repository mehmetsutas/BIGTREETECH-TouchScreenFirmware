...
#define _LANGUAGE_CZ_H_
    ...
    #define CZ_HOME                   "Domů"
    #define CZ_DISABLE_STEPPERS       "Motory"
    ...
    #define CZ_ABL_COMPLETE           "Vyrovnání Komplet"
    #define CZ_ABL_SMART_FILL         "Chybějící body sondy\nbyly vyplněny inteligentně.\n \nPozn: Nezapomeň uložit!"
    #define CZ_ABL_SETTINGS           "Bilineární vyrovnání"
    #define CZ_ABL_SETTINGS_UBL       "UBL vyrovnání"
    #define CZ_ABL_SETTINGS_UBL_SAVE  "Uložit do slotu"
    #define CZ_ABL_SETTINGS_UBL_LOAD  "Nahrát ze slotu"
    #define CZ_ABL_SLOT0              "Slot 0"
    ...
    #define CZ_CONFIRMATION           "Jste si jistý?"
    #define CZ_DOWN                   "Dolů"
    #define CZ_UP                     "Nahoru"
    ...
    #define CZ_SIMULATOR_BG_COLOR     "Marlin - Barva pozadí"
    #define CZ_SIMULATOR_FONT_COLOR   "Marlin - Barva písma"
    ...
    #define CZ_MAGENTA                "Purpurová"
    #define CZ_PURPLE                 "Nachová"
    #define CZ_LIME                   "Limetková"
    #define CZ_DARKBLUE               "Tmavá Modrá"
    #define CZ_DARKGREEN              "Tmavá Červená"
    #define CZ_DARKGRAY               "Tmavá Šedá"
    #define CZ_DISCONNECT             "Odpojit"
    #define CZ_BAUDRATE               "Serial Port"
    ...
    #define CZ_FILAMENT_SENSOR        "Senzor filamentu"
    ...
    #define CZ_PARAMETER_SETTING      "Parametry"
    #define CZ_ON                     "ON"
    #define CZ_OFF                    "OFF"
    ...
    #define CZ_KNOB_LED_IDLE          "Rotační knob LED idle"
    ...
    #define CZ_FILE_LISTMODE          "Zobrazit soub.jako seznam"
    ...
    #define CZ_LIN_ADVANCE            "Linear Advance"
    ...
    #define CZ_PLR_EN                 "Obnova po ztrátě napájení"
    ...
    #define CZ_EEPROM_RESTORE_INFO    "Obnovit nastavení z\nEEPROM?"
    #define CZ_EEPROM_RESET_INFO      "Reset EEPROM na výchozí hodnoty?"
    #define CZ_RETRACT_FEEDRATE       "Rychlost zatažení"
    #define CZ_RETRACT_LENGTH         "Délka zatažení"
    #define CZ_RETRACT_SWAP_LENGTH    "Délka zatažení Swap"
    #define CZ_RETRACT_Z_LIFT         "Z zvýšení při zatažení"
    #define CZ_RETRACT_AUTO           "Auto Firmware Retract"
    #define CZ_RECOVER_FEEDRATE       "Rychlost obnovení"
    #define CZ_SWAP_RECOVER_FEEDRATE  "Rychlost obnovení Swap"
    ...
    #define CZ_PID                    "PID"
    #define CZ_PID_TITLE              "PID autokalibrace"
