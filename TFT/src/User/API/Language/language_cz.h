...
#define _LANGUAGE_CZ_H_
    ...
    #define STRING_STATUS_SCREEN          "Povolit Status Screen"
    ...
    #define STRING_DEFAULT_MODE           "Defaultní mód"
    ...
    #define STRING_ONBOARD_SD_SUPPORT     "Podpora onboard SD"
    #define STRING_M27_ALWAYS_ACTIVE      "M27 Vždy aktivní"
    #define STRING_LONG_FILENAME_SUPPORT  "Podpora dlouhých názvů"
    ...
    #define STRING_PS_ON_ACTIVE_HIGH      "Napájení aktivní HIGH"
    #define STRING_FIL_RUNOUT             "Senzor filamentu"
    #define STRING_FIL_RUNOUT_INVERTING   "Otoč logiku senzoru filam."
