...
const char *const en_pack[LABEL_NUM]={
  ...
  EN_NOTIFY_KILL,
  EN_NOTIFY_CANCEL,
  EN_PROMPT_FILAMENT_INSERT,
  EN_PROMPT_HEATER_TIMEOUT,
  EN_PROMPT_REHEATING,
  EN_PROMPT_REHEAT_DONE,
  EN_FILAMENT_LOAD,                           //"Load"
  EN_FILAMENT_UNLOAD,
  EN_FILAMENT_CHANGE,
  EN_PROMPT_FILAMENT_LOAD,   
  EN_PROMPT_FILAMENT_CONTINUE,
  EN_PROMPT_NOZZLE_PARKED,
  EN_PROMPT_M0_M1  
};
/*
const char *const cn_pack[LABEL_NUM]={
  ...
  CN_NOTIFY_KILL,
  CN_NOTIFY_CANCEL,
  CN_PROMPT_FILAMENT_INSERT,
  CN_PROMPT_HEATER_TIMEOUT,
  CN_PROMPT_REHEATING,
  CN_PROMPT_REHEAT_DONE
};
...
const char *const ru_pack[LABEL_NUM]={
  ...
  RU_NOTIFY_KILL,
  RU_NOTIFY_CANCEL,
  RU_PROMPT_FILAMENT_INSERT,
  RU_PROMPT_HEATER_TIMEOUT,
  RU_PROMPT_REHEATING,
  RU_PROMPT_REHEAT_DONE
};
...
const char *const jp_pack[LABEL_NUM]={
  ...
  JP_NOTIFY_KILL,
  JP_NOTIFY_CANCEL,
  JP_PROMPT_FILAMENT_INSERT,
  JP_PROMPT_HEATER_TIMEOUT,
  JP_PROMPT_REHEATING,
  JP_PROMPT_REHEAT_DONE
};
...
const char *const am_pack[LABEL_NUM]={
  ...
  AM_NOTIFY_KILL,
  AM_NOTIFY_CANCEL,
  AM_PROMPT_FILAMENT_INSERT,
  AM_PROMPT_HEATER_TIMEOUT,
  AM_PROMPT_REHEATING,
  AM_PROMPT_REHEAT_DONE
};
...
const char *const de_pack[LABEL_NUM]={
  ...
  DE_NOTIFY_KILL,
  DE_NOTIFY_CANCEL,
  DE_PROMPT_FILAMENT_INSERT,
  DE_PROMPT_HEATER_TIMEOUT,
  DE_PROMPT_REHEATING,
  DE_PROMPT_REHEAT_DONE
};
...
const char *const cz_pack[LABEL_NUM]={
  ...
  CZ_NOTIFY_KILL,
  CZ_NOTIFY_CANCEL,
  CZ_PROMPT_FILAMENT_INSERT,
  CZ_PROMPT_HEATER_TIMEOUT,
  CZ_PROMPT_REHEATING,
  CZ_PROMPT_REHEAT_DONE
};
...
const char *const es_pack[LABEL_NUM]={
  ...
  ES_NOTIFY_KILL,
  ES_NOTIFY_CANCEL,
  ES_PROMPT_FILAMENT_INSERT,
  ES_PROMPT_HEATER_TIMEOUT,
  ES_PROMPT_REHEATING,
  ES_PROMPT_REHEAT_DONE
};
...
const char *const fr_pack[LABEL_NUM]={
  ...
  FR_NOTIFY_KILL,
  FR_NOTIFY_CANCEL,
  FR_PROMPT_FILAMENT_INSERT,
  FR_PROMPT_HEATER_TIMEOUT,
  FR_PROMPT_REHEATING,
  FR_PROMPT_REHEAT_DONE
};
...
const char *const pt_pack[LABEL_NUM]={
  ...
  PT_NOTIFY_KILL,
  PT_NOTIFY_CANCEL,
  PT_PROMPT_FILAMENT_INSERT,
  PT_PROMPT_HEATER_TIMEOUT,
  PT_PROMPT_REHEATING,
  PT_PROMPT_REHEAT_DONE
};
...
const char *const it_pack[LABEL_NUM]={
  ...
  IT_NOTIFY_KILL,
  IT_NOTIFY_CANCEL,
  IT_PROMPT_FILAMENT_INSERT,
  IT_PROMPT_HEATER_TIMEOUT,
  IT_PROMPT_REHEATING,
  IT_PROMPT_REHEAT_DONE
};
...
const char *const pl_pack[LABEL_NUM]={
  ...
  PL_NOTIFY_KILL,
  PL_NOTIFY_CANCEL,
  PL_PROMPT_FILAMENT_INSERT,
  PL_PROMPT_HEATER_TIMEOUT,
  PL_PROMPT_REHEATING,
  PL_PROMPT_REHEAT_DONE
};
...
const char *const sk_pack[LABEL_NUM]={
  ...
  SK_NOTIFY_KILL,
  SK_NOTIFY_CANCEL,
  SK_PROMPT_FILAMENT_INSERT,
  SK_PROMPT_HEATER_TIMEOUT,
  SK_PROMPT_REHEATING,
  SK_PROMPT_REHEAT_DONE
};
*/
const char *const tr_pack[LABEL_NUM]={
  ...
  TR_TFTSD_REMOVED,
  TR_U_DISK,
  TR_READ_U_DISK_ERROR,
  TR_U_DISK_INSERTED,
  TR_U_DISK_REMOVED,
  TR_ONBOARDSD,
  TR_READ_ONBOARDSD_ERROR,
  TR_FILAMENT_RUNOUT,
  TR_PREHEAT,
  TR_PREHEAT_BOTH,
  TR_PREHEAT_PLA,
  ...
  TR_NOTIFY_KILL,
  TR_NOTIFY_CANCEL,
  TR_PROMPT_FILAMENT_INSERT,
  TR_PROMPT_HEATER_TIMEOUT,
  TR_PROMPT_REHEATING,
  TR_PROMPT_REHEAT_DONE,
  TR_FILAMENT_LOAD,                            //"Load"
  TR_FILAMENT_UNLOAD, 
  TR_FILAMENT_CHANGE,
  TR_PROMPT_FILAMENT_LOAD,     
  TR_PROMPT_FILAMENT_CONTINUE,
  TR_PROMPT_NOZZLE_PARKED,
  TR_PROMPT_M0_M1  
};
